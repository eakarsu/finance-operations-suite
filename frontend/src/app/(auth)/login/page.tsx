...
export default function LoginPage() {
  ...
  const onSubmit = async (event: FormEvent) => {
    ...
    setSubmitting(false);
    if (!ok) {
      setError('Use the seeded finance suite demo credentials.');
      return;
    }
  ...
  return (
    <div className="auth-wrap">
      <div className="auth-card">
        <div className="pill">Finance Operations</div>
        <h1 style={{ marginBottom: 8 }}>Unified finance login</h1>
        <div className="muted">
          One login for reporting, tax, expenses, controls, collections, and AI operations.
        </div>
