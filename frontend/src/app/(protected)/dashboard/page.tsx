...
export default function DashboardPage() {
  return (
    <UnifiedShell
      ...
      subtitle="One merged finance view for reporting, tax, spend, controls, collections, documents, and AI operations."
    >
      ...
      <div className="grid columns-2">
        <div className="card stack">
          ...
          <div className="muted">
            This suite removes project-based navigation and groups shared finance jobs into one surface.
            Reporting, tax, expense audit, collections, and AI are presented as platform features.
          </div>
