...
PORT="${PORT:-3300}"
DB_NAME="${PGDATABASE:-finance_operations_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      Finance Operations Suite"
echo "======================================="
echo
...
echo "Starting finance suite frontend on http://localhost:$PORT"
echo "Login: admin@finance-ops.local / admin123"
